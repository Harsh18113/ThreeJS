...
var FormGroup = function (_React$Component) {
  ...
  function FormGroup(props) {
    ...
    _this.UNSAFE_componentWillReceiveProps = function (nextProps) {
      ...
      var nextPropsErrors = (0, _immutable.fromJS)(nextProps.fieldErrors);
      var thisPropsErrors = (0, _immutable.fromJS)(_this.props.fieldErrors);

      var updatedState = {};

      if (!(0, _immutable.is)(nextPropsSchema, thisPropsSchema)) {
        updatedState.fields = (0, _immutable.fromJS)(nextProps.schema);
      }

      if (!(0, _immutable.is)(nextPropsErrors, thisPropsErrors)) {
        updatedState.fieldErrors = nextProps.fieldErrors;
      }

      if (updatedState.fields || updatedState.fieldErrors) _this.setState(updatedState);
    };
