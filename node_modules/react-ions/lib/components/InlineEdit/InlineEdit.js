...
var InlineEdit = function (_React$Component) {
  ...
  function InlineEdit(props) {
    ...
    _this.getDatepicker = function () {
      var dateClass = _bind2.default.bind(_style2.default)(_style2.default['inline-edit-date'], _this.state.loading ? 'loading' : '');
      var dateRange = {
      ...
      return _react2.default.createElement(_DatePicker2.default, {
        value: _this.state.value,
        min: _this.props.dateConfig ? _this.props.dateConfig.min : dateRange.min,
        max: _this.props.dateConfig ? _this.props.dateConfig.max : dateRange.max,
        changeCallback: _this.handleSave,
    ...
    _this.render = function () {
      ...
      var overflowWrapperClass = cx(_style2.default['inline-text-overflow-wrapper'], ['select', 'date'].indexOf(_this.props.type) !== -1 ? _style2.default['visible'] : '');
...
InlineEdit.propTypes = {
   ...
   * Type of the field.
   */
  type: _propTypes2.default.oneOf(['text', 'select', 'date']),
  /**
   ...
   */
  dateConfig: _propTypes2.default.object
};
