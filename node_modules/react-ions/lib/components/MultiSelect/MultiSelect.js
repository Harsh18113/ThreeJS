...
var MultiSelect = function (_React$Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function render() {
      ...
      var TagListComponent = this.props.tagList || _TagList2.default;

      return _react2.default.createElement(
        'div',
        { className: multiSelectClasses },
        elements,
        _react2.default.createElement(TagListComponent, { tags: this.state.selected, displayProp: this.props.displayProp, onRemove: this.onRemove })
      );
    }
  }]);
...
MultiSelect.propTypes = {
   ...
   */
  tagList: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.node])
};
